...
bool LoadTGA(glmTexture * texture, char * filename)				// Load a TGA file
{
...
bool LoadUncompressedTGA(glmTexture * texture, char * filename, FILE * fTGA)	// Load an uncompressed TGA (note, much of this code is based on NeHe's 
...
bool LoadCompressedTGA(glmTexture * texture, char * filename, FILE * fTGA)		// Load COMPRESSED TGAs
{ 
